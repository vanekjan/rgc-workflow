...
def main():
    ...
    runner_script = path_for_command(repo_root, runner.get("script", "scripts/run_all_hipo_new.sh"))
    ...
    sbatch_script = repo_root / "scripts" / "batch" / "rgcskim_array_new.sbatch"

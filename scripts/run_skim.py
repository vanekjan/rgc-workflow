...
"""
run_skim.py
YAML wrapper for run_all_hipo.sh.
...
validates it, builds the equivalent run_all_hipo.sh command, prints it, and
...
def build_command(cfg):
    ...
    runner_script = as_string(runner.get("script", "./run_all_hipo.sh"))
